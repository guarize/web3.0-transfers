  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-20 xmf:mr-60">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 p-3 btn-outline-primary transition duration-300 ease-in-out focus:outline-none focus:shadow-outline border border-purple-700 hover:bg-purple-700 hover:text-white font-normal rounded cursor-pointer w-2/3"
            >
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:-mt-8 mt-10">
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 w-72 my-5 eth-card white-glassmorphism" data-aos="flip-right" data-aos-once data-aos-duration={1500}>
